...
import com.alfrosoft.kwiqshopapp.databinding.ActivityUserProfileBinding
import com.alfrosoft.kwiqshopapp.firestore.FireStoreClass
import com.alfrosoft.kwiqshopapp.model.User
            ...
            R.id.btn_submit -> {
                if (validateUserProfileData()) {
                    ...
                    if (mSelectedProfileImageFileUri != null) {
                        ...
                        FireStoreClass().uploadImageToCloudStorage(this, mSelectedProfileImageFileUri,
